...
業務機能の設計は `application/design.md` と `application/features/` に記載しています。フェーズ 1 では家族 Hub と買い物リストを実装予定です。
...
| `../architecture/object-storage.md` | ファイルストレージ（`FILE_STORAGE_ROOT`） |
| `../roadmap.md` | 実装予定 |
